<head>
    ...
    <title>Going to be ewallet</title>
    <!-- Google font-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('cuba/assets/css/vendors/owlcarousel.css') }}">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('cuba/assets/css/app.css') }}">
